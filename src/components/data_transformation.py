...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        Function used for transforming/ preprocessing of the data, returns the preprcessor as output.
        """
        try:
            ...
            logging.info("Cataegorical columns encoding Completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(
                ...
                file_path=self.data_transformation_cofig.preprocessor_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_transformation_cofig.preprocessor_file_path
